...
const Hero = () => {
  ...
  return (
    <Section name="hero">
      <Section.Container className="flex-col lg:flex-row lg:bg-slate-200 lg:dark:bg-slate-800">
        <div className="body flex flex-col w-full lg:w-2/5 gap-6">
          ...
          <div className="text-xl leading-relaxed text-slate-600 dark:text-slate-300">
            <p>
              I&apos;m Joey, a full-stack web developer based in Portland, OR. I
              work with brands and businesses of all sizes to create modern,
        ...
        <div className="hidden md:flex supporting-image flex w-full lg:w-3/5">
          <svg
            id="Layer_1"
            data-name="Layer 1"
